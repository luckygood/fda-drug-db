...
import { Search, Loader2, Stethoscope, ChevronDown, ChevronUp, AlertTriangle, FlaskConical, ShieldAlert, FileText } from 'lucide-react'
...
/** 有效性/安全性摘要卡（摘自 FDA 说明书原文） */
function DrugSummaryCards({ drug }: { drug: DiseaseDrug }) {
  const ec = drug.efficacy_card
  const sc = drug.safety_card
  if (!ec && !sc) {
